...
const routes = [
  {
    ...
    children: [
      { name: "home", path: "", redirect: { name: "deliveryIndex" } },
      {
        name: "deliveryIndex",
        path: "delivery",
        component: () => import("pages/DeliveryIndex.vue"),
      },
      {
        name: "directIndex",
        path: "direct",
        component: () => import("pages/DirectIndex.vue"),
      },
    ],
  },
  {
    ...
    children: [
      {
        name: "deliveryList",
        path: ":category",
        component: () => import("pages/DeliveryList.vue"),
        meta: { title: "배달" },
      },
    ],
  },
    ...
    children: [
      {
        name: "directList",
        path: ":category",
        component: () => import("pages/DirectList.vue"),
        meta: { title: "직거래" },
      },
    ],
  },
    ...
    children: [
      {
        name: "addressSet",
        path: "address",
        component: () => import("pages/AddressSet.vue"),
        meta: { title: "주소 설정" },
      },
      {
        name: "my",
